...
每次检测输出简洁日志：
```
[2026-04-24 14:30:05.123] [BGIguard_v4.0.0] [INFO] 检测 14:30:05 | 内存: 45% | BetterGI: 运行 | 游戏: YuanShen
```

内存警告（ >= 配置值-5% ）：
```
[2026-04-24 14:35:00.123] [BGIguard_v4.0.0] [WARN] [内存警告] 已用: 32768MB/49152MB (67%) | 物理: 16384MB | 虚拟: 32768MB
```

进程终止日志（含用户信息和 SID）：
```
[2026-04-24 14:40:00.123] [BGIguard_v4.0.0] [INFO] 已终止 BetterGI.exe PID:1234 (用户:DESKTOP\Bcmdy, SID:S-1-5-21-...)
[2026-04-24 14:40:00.456] [BGIguard_v4.0.0] [WARN] BetterGI.exe PID:5678 属于用户:DESKTOP\Admin, SID:S-1-5-21-...，跳过终止
```
